        ...
        <form onSubmit={(e) => handleLogin(e)}>
          <div className="form-outline mb-4">
            <input
              ...
              onBlur={(x) => setLoginUser({ ...loginUser, userName: x.target.value })}
              required
            />
          ...
          <div className="form-outline mb-4">
            <input
              type="password"
              className="form-control"
              onChange={(x) => setLoginUser({ ...loginUser, password: x.target.value })}
              required
            />
          ...
          <div className="text-center">
            <p id="registerHelp">
              Not a member? <Link to="/myRegistration"> Register</Link>
            </p>
          </div>
        </form>
      </div>
